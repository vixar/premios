...
if ($_POST) {
    if ( !isset($_SESSION['sended']) ) {
       ...
       if (!isset($error)) {
            ...
            $mail->Username = "YOUR_USERNAME_EMAIL_ADDRESS_HERE"; // <------------ Smtp authentication - username here

            //Password to use for SMTP authentication
            $mail->Password = "YOUR PASSWORD_HERE"; // <------------ Smtp authentication -password here
            ...
            $mail->addAddress('YOUR_EMAIL_HERE', 'YOUR_NAME'); // <----------- CHANGE YOUR WITH YOUR EMAIL ADDRES
